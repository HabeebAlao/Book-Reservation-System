...
if ($value == "CheckLoginDetails") {
    ...
    if ($result->num_rows > 0) {
        ...
        setcookie("user", $username_, time(+3600));
    ...
    if ($_COOKIE['user'] !== "null"){
        ...
        if ( (!empty($_POST['bookName'])) or ("Category" !==($_POST['BookCategory'])) ){
            ...
            if (($result->num_rows > 0)) {
                ...
                while ($row = $row = $result->fetch_assoc()) {   //Creates a loop to loop through results
    ...
    if ($_COOKIE['user']!=="null"){
        ...
        $sql = "SELECT ISBN, ReservedDate, Username FROM Reservations WHERE (Username = '$user'); ";
        ...
        if ($result->num_rows > 0) {
            ...
            echo "<tr><th>ISBN</th><th>BookTitle</th><th>Unreserve</th></tr>"; // columns 
